...
def clean_data():
    ...
    print("Reading raw demographic data...")
    input_path = os.path.join(script_dir, "raw_demographic_data.csv")
    ...
    output_file = os.path.join(IMAGE_DIR, "final_UIDAI_cleaned_demographic_data.csv")
